...
export interface SentimentSnapshotSource { input: SentimentInput; result: SentimentResult; }
...
export interface SealedSentimentSnapshot { ref: SentimentDatasetSnapshotRef; points: SentimentSnapshotPoint[]; }
