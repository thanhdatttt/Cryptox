...
function createSentimentModule(_deps) {
  return {
    analyze: exports.analyze,
    readLatestForNews: exports.readLatestForNews,
    createSnapshot: exports.createSnapshot,
    readSnapshot: exports.readSnapshot,
  };
}
