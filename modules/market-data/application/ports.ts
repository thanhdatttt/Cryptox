...
export interface MarketDataModuleDependencies { providerRegistry: unknown; candleRepository: unknown; snapshotRepository: SnapshotRepository; latestValueCache: unknown; clock: Clock; observability: MarketDataObservability; }
