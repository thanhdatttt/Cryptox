...
exports.createMarketDataSnapshotReader = exports.shutdown = exports.subscribeMarketData = exports.readDatasetSnapshot = exports.createDatasetSnapshot = exports.readCandles = void 0;
...
function createMarketDataModule(_deps) { return { readCandles: exports.readCandles, createDatasetSnapshot: exports.createDatasetSnapshot, readDatasetSnapshot: exports.readDatasetSnapshot, subscribeMarketData: exports.subscribeMarketData, shutdown: exports.shutdown }; }
