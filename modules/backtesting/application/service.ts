...
export class BacktestingService implements BacktestLogApi {
  ...
  private requiredWarmupCandles(definitions: StrategyDefinition[]): number {
  ...
  private async validateStrategyReferences(ownerUserId: string, command: StartManualBacktestCommand | SubmitSearchCandidateCommand): Promise<{ strategyDefinitions: StrategyDefinition[]; compositeDefinition: CompositeStrategyDefinition; warmupCandles: number }> {
