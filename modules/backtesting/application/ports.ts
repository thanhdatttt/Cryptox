...
export interface BacktestingRepository {
  ...
  completeAttempt(input: { candidate: StoredCandidate; attempt: BacktestAttemptAudit; result: CompletedBacktestResult; metrics: EvaluationMetrics; experiment: StoredExperiment }): Promise<void>;
