...
const trade = (resultPercent: number): Trade => ({ id: `t-${resultPercent}`, sequence: 1, pair: "BTCUSDT", backtestAttemptId: "a", signal: "LONG", entryTime: "2025-01-01T00:00:00.000Z", marketEntryPrice: 100, entryPrice: 100, stopLoss: null, takeProfit: null, exitTime: "2025-01-01T01:00:00.000Z", marketExitPrice: 100, exitPrice: 100, exitReason: "STRATEGY_CLOSE", quantity: 1, notionalEntryValue: 100, grossProfit: resultPercent, feeAmount: 0, slippageBps: 5, slippageAmount: 0, profit: resultPercent, resultPercent, result: resultPercent > 0 ? "WIN" : resultPercent < 0 ? "LOSS" : "BREAKEVEN" });
