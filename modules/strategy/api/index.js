...
function createStrategyModule(_deps) {
  return {
    listStrategies: exports.listStrategies,
    resolveStrategy: exports.resolveStrategy,
    combineSignals: exports.combineSignals,
    defineStrategy: async () => notImplemented(),
    defineComposite: async () => notImplemented(),
  };
}
