...
describe("PostgreSQL strategy repositories", () => {
  ...
  it("commits generated definitions, composites, and audit in one transaction", async () => {
    ...
    await unitOfWork.commit({
      ownerUserId: "user-id",
      definitions: [{ id: "strategy-1", logicalFamilyKey: "strategy:RSI", strategyName: "RSI", implementationVersion: "1", implementationSha256: "sha", version: 1, parameters: { period: 14 }, createdAt: "2025-01-01T00:00:00.000Z" }],
      composite: { id: "composite-1", logicalFamilyKey: "composite:weighted", version: 1, method: "WEIGHTED_SCORE", components: [{ strategyDefinitionId: "strategy-1", weight: 1 }], thresholds: { buy: 0.3, sell: -0.3 }, createdAt: "2025-01-01T00:00:00.000Z" },
