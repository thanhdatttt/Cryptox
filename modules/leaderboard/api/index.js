...
exports.score = score;
const topK = (auth, leaderboardScopeId) => defaultService.topK(auth, leaderboardScopeId);
exports.topK = topK;
const rankSearchRun = (auth, searchRunId) => defaultService.rankSearchRun(auth, searchRunId);
