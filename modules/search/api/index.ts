import type { SearchRun, SearchSpaceConfig, StopCondition, GeneratorType, LoopStatus, SearchRunRankingEntry, SearchRunSummary } from "../domain/contracts";
...
export const list: SearchModulePublicApi["list"] = (auth, limit) => defaultService.list(auth, limit);
