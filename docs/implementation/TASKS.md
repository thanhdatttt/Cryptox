...
| I-02 | REVIEW | 6 | YES | INS-128 Manager plus at most three disjoint internal reviewers/test children | `MVP_IMPLEMENTATION` / `c6b9690885e02e042c4f3e22a25e4637ad601517` authorization checkpoint; bounded review checkpoint commit pending | `BLOCKED → READY → IN_PROGRESS → REVIEW`; backend/frontend fixture-boundary E2E evidence, clean install, workspace tests, build/typecheck/lint, architecture/artifact/scope/runtime/diff gates PASS; real PostgreSQL/Auth, Binance, News, configured browser demo, Docker Compose migration, OpenSpec CLI, and source/spec status reconciliation BLOCKED or UNVERIFIED; no DONE or downstream promotion |
